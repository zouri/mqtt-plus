    ...
    ColumnLayout {
        ...
        Item {
            ...
            ListView {
                ...
                clip: true
                spacing: 7
                model: root.appController.scriptTestSamples
                reuseItems: true
                ...
                delegate: Rectangle {
                    ...
                    Accessible.name: qsTr("Use sample from %1").arg(sampleDelegate.topic)
                    ...
                    Column {
                        ...
                        RowLayout {
                            ...
                            AppBadge {
                                ui: root.ui
                                label: sampleDelegate.formatName
                                badgeRadius: 7
                                horizontalPadding: 6
                                verticalPadding: 3
                            }
                        ...
                        Label {
                            width: parent.width
                            text: qsTr("%1 • %2 B")
                                  .arg(sampleDelegate.timestamp)
                                  .arg(sampleDelegate.payloadSize)
                            color: root.ui.textMuted
                            font.pixelSize: 10
                            elide: Label.ElideRight
                        }
                    ...
                    Keys.onPressed: (event) => {
                        if (event.key === Qt.Key_Return
                            ...
                            root.applySample(root.appController.scriptTestSamples.rowAt(sampleDelegate.index))
                            event.accepted = true
                        }
                    }
