...
Rectangle {
    ...
    ColumnLayout {
        ...
        ListView {
            ...
            model: control.appController.sessionsModel
            reuseItems: true
            ...
            delegate: Rectangle {
                ...
                Accessible.name: qsTr("Connection %1").arg(sessionDelegate.modelData.name)
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        radius: 4
                        color: control.ui.stateColor(sessionDelegate.modelData.state)
                    }
                ...
                Menu {
                    ...
                    MenuItem {
                        text: qsTr("Delete")
                        enabled: control.appController.sessionsModel.length > 1
